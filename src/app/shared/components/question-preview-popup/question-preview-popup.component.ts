...
@Component({
  selector: 'app-question-preview-popup',
  imports: [CommonModule, FormsModule, ButtonModule, CheckboxModule, DialogModule],
  templateUrl: './question-preview-popup.component.html',
  styleUrl: './question-preview-popup.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class QuestionPreviewPopupComponent {
